...
var readTsConfig = /* @__PURE__ */ __name(({ tsConfigPath, typesFolder, compiledTypesFolder, context }) => {
  ...
  const configContent = import_typescript.default.parseJsonConfigFileContent(readResult.config, import_typescript.default.sys, (0, import_path.dirname)(resolvedTsConfigPath));
